"""
Вспомогательный скрипт для извлечения 50000 заголовков из дампов википедии
и извлечения статей по списку заголовков (написан на коленке и особо не дорабатывался)
"""
